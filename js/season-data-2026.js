...
const FESTIVALS_2026 = [
  ...
  },
  {
    ...
    races:null,
    headline:'Day 3 priced — the 250th St Leger. 7/7 gated, 16 picks, £16.00, and the cleanest card of the meeting: every draw sequence unbroken. The LONG slot opens TWICE in one afternoon for the first time this season — Station X 20/1 in the 22-runner Portland and Pinatubo\'s Legacy 28/1 in the 17-runner mile handicap — both provisional under rule 16. Five first-time headgear markers on 87 runners, one of them cheekpieces on the 2/1 Classic favourite Enceladus. Five columns in and the card\'s first 3x: Enceladus (Spotlight + Mullington + Frick) — which landed on a pick rule 8 had already demoted to NB before any column was read, the strongest confirmation that rule has produced all season. The first two dissent crossovers arrived with it, Breacher and Apollo One, both already named on the card as exclusions. The §6 price test across 19 quoted prices found three shorter than our card, and the biggest matters: Christmas Day 5/2→9/4 half-reverses the market split the Pierre Bonnard NAP was built on. Recorded at full strength — the pick stands, because rule 8 forbids moving on one column. Friday SETTLED +£3.47 on £17.00 (+20.4%) — 5 winners and 7 placed from 17, the best day of the season and the first with the LONG in profit (Optician 3rd at 14/1, +£1.25). Rule 8 vindicated in a new shape: two columns opposed Caballo De Mar by name and backed Beylerbeyi; he won and Beylerbeyi was second. No crossover horse won a race all day. Day 1 settled −£10.60 (−66.2%).',
