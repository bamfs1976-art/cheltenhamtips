...
const FESTIVALS_2026 = [
  ...
  },
  {
    ...
    races:14,
    headline:'Both cards declared and gated 14/14 \u2014 29 picks, \u00a329.00, 149 runners with a draw against every one. The LONG opens once in fourteen races, the 28-runner bet365 Cambridgeshire, and Alcarath clears all three legs at 20/1. TEN COLUMNS on Friday give 22 opinions and SIX CROSSOVERS, three on horses we hold (Light Of Dawn NAP, Lizzana and Fortitudine NB) and three on horses we do not \u2014 Spirited Gesture 3x at 9/4, Talk Of New York 3x at 4/6, Without Prejudice 2x. Rule 8 satisfied by construction: the 3x horse under 3/1 is not our NAP. THE STAR RATING FINDING: Coedana carries \u2605\u2605\u2605 on the Spotlight verdict row and \u2605 on Spotlight\u2019s own Lucky 15 leg \u2014 same desk, same horse, same race \u2014 so the star belongs to the tip row, not the horse, and the St Leger card read it wrong when it called that rating rare. THE MARKET FINDING: the RP forecast book averages 123.1% and the board 115.2%, so a horse can hold its share and still read as a drift; normalising to the book turns 7 STEAM / 31 DRIFT into 21 / 24 / 21. All 17 RP prices match our card exactly. Alignment 9/22 (41%).',
