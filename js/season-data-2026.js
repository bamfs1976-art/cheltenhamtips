...
const FESTIVALS_2026 = [
  ...
  },
  {
    ...
    races:null,
    headline:'Day 3 SETTLED −£6.57 on £16.00 (−41.0%) and Day 4 priced. The 250th St Leger went to Highwayman 11/1 — Joseph O\'Brien\'s other runner, held by none of five columns — while the card\'s only 3x, Enceladus, ran second and Christmas Day, opposed by name, was the unplaced 7/4 favourite. Rule 8 right for a fifth meeting. The day\'s real finding: all three horses this card opposed on a DRIFT had shortened by the off and two of them won, while our own two biggest market reads inverted in opposite directions the same afternoon — we measure forecast-to-racecard and never racecard-to-off, and the second move is the bigger one. Both LONGs lost but both place bands held, so they lost on merit. Day 4 is priced at £18.00 with the festival\'s ONLY first-time wind operation backed as the LONG (Mo Of Cairo, w1, 14/1) and a first-in-the-archive ★★★ Spotlight rating on our NB. Meeting −£13.70 on £49.00; season −£109.78 (−14.2%).',
