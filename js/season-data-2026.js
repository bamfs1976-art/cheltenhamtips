...
const FESTIVALS_2026 = [
  ...
  },
  {
    ...
    races:14,
    headline:'Both cards declared and gated 14/14 \u2014 29 picks, \u00a329.00, 149 runners with a draw against every one. The LONG opens once in fourteen races, the 28-runner bet365 Cambridgeshire, and Alcarath clears all three legs at 20/1 on first-time cheekpieces for a yard at 78%. TWO COLUMNS NOW ON FRIDAY and the second produced two crossovers immediately: Fortitudine, already our NB, and Talk Of New York at 4/6, which we do not hold \u2014 flagged as dissent, and as the banker marker \u00a76 says a consensus on an odds-on favourite is. Independence proved by three divergences in five shared races. THE FINDING: the market signal has been measured wrong all season. Differencing the RP betting forecast against the board reads 7 STEAM to 31 DRIFT on Friday \u2014 but the forecast book averages 123.1% and the board 115.2%, so the board is eight points looser in all seven races and a horse can hold its share and still read as a drift. Normalising to the book and taking the deviation from the race median gives 21 STEAM, 24 DRIFT, 21 flat. Third straight meeting the market method has been found defective, first with a fix. Read the Cambridgeshire terms off the bookmaker \u2014 the ladder says five places and the St Leger paid five in none of thirty-one races.',
