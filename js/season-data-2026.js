...
const FESTIVALS_2026 = [
  ...
  },
  {
    ...
    races:14,
    headline:'Both cards declared and gated 14/14 \u2014 29 picks, \u00a329.00, 149 runners with a draw against every one. The LONG opens once in fourteen races, the 28-runner bet365 Cambridgeshire, and Alcarath clears all three legs at 20/1. NINE COLUMNS on Friday produce 17 rows, 21 opinions and FIVE CROSSOVERS, three of them on horses we do not hold \u2014 Spirited Gesture 3x at 9/4, Talk Of New York 3x at 4/6, Without Prejudice 2x. Rule 8 satisfied by construction: the 3x horse under 3/1 is not our NAP. THE STAR RATING FINDING: Coedana carries \u2605\u2605\u2605 on Spotlight\'s verdict and \u2605 on Spotlight\'s own Lucky 15 leg \u2014 same desk, same horse, same race \u2014 so the star belongs to the tip row, not the horse, and the St Leger card read it wrong when it called \u2605\u2605\u2605 a rare confidence signal. Four multi-star rows on one page. THE MARKET FINDING: differencing the RP forecast against the board reads 7 STEAM to 31 DRIFT, but the forecast book averages 123.1% and the board 115.2%, so a horse can hold its share and still read as a drift; normalising to the book gives 21 STEAM, 24 DRIFT, 21 flat. All 17 quoted prices match our card exactly \u2014 no market move to read. Alignment 8/21 (38%).',
