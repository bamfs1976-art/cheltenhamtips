...
const FESTIVALS_2026 = [
  ...
  },
  {
    ...
    races:14,
    headline:'FRIDAY SETTLED \u2212\u00a30.07 on \u00a314.00 (\u22120.5%) \u2014 seven pence off level, the closest any day has finished all season. 3 winners and 3 placed from 14, with a one-two in the Princess Royal: Coedana (NB) won at 7/1 and Inis Mor (NAP) second. Eight of the fourteen made the first three and two were paid nothing, in races the card had already flagged as too few places. The opposed favourite won \u2014 Talk Of New York 4/9F \u2014 having been named in advance as the best horse in his race that would probably win; the reasoning holds but the bet365 boost to 1/1, priced here that morning at +8 to +14p per \u00a31, would have doubled. The St Leger place ladder went 7 from 7 and is now 38 races without an exception, while PLACE_BANDS was wrong in five of seven. Ruby Moon, flagged that morning at 33/1 on the card against 22/1 best odds, ran third at 16/1. Every crossover we held made the frame. Nick Luck aligned 4 of 5 with this card, the highest of any column, and had no winner. Saturday and the 28-runner Cambridgeshire still to run, \u00a315.00 at stake.',
